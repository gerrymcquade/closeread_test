...
::: {#cr-fig3}
![](eth_pm25_2022.svg){width="70%"}
:::

we can even zoom in to look at some of our communities... for example around Addis Ababa: [@cr-fig3]{pan-to="50%,0%" scale-by="3"}

or even look at the difference across our communities by panning up towards Tigray! [@cr-fig3]{pan-to="50%,75%" scale-by="3"}
...
![](eth_pm25_2022.svg){width="50%" width="50%" data-credit="Young Lives, using V6.GL.02, Washington University St. Louis" data-label="PM2.5 in 2022"}
